package com.respeso.springmvcnavinreddy;
...
import com.respeso.springmvcnavinreddy.dao.AlienDao;
...
public class HomeController {
	...
	public void modelData(Model m) {
		m.addAttribute("title", "Alien Result Page");
	}
...
//	}
	 ...
	 *
	 * @PostMapping = @RequestParam(method="post", value="address")
	 */
	@PostMapping("addalien.modelattr") 
	public String addAlienModel(@ModelAttribute Alien a) {
		return "result";
	}
	
	/*
	 * By default String return will give the name of the page to show.
	 */
...
//		return aliens.toString(); // error
	...
	public String addAlien(@ModelAttribute("result") Alien a) { // Auto-mapped to ${result} variable
		dao.addAlien(a);
		return "showAliens";
	}
